	...
	public EntradaMateriais() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int quantidade1 = Integer.parseInt(textField_1.getText().toString());
				...
				int quantidade2 = Integer.parseInt(textField_2.getText().toString());
				...
				int quantidade3 = Integer.parseInt(textField_3.getText().toString());
				...
				int quantidade4 = Integer.parseInt(textField_4.getText().toString());
